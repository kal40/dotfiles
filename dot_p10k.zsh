# Generated by Powerlevel10k configuration wizard on 2024-09-27 at 13:24 CEST.
...
# 24h time, slanted separators, sharp heads, blurred tails, 2 lines, dotted,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 32 )) && branch[33,-13]="…"  # <-- this line
